...
const HollywoodMovie = ({ searchTerm }) => {
  ...
  useEffect(() => {
    const fetchMovies = async () => {
      try {
        ...
        const hollywoodMovies = data.filter(movie => movie.category === 'Hollywood');
  ...
  const currentMovies = movies.slice(indexOfFirstMovie, indexOfLastMovie);
    ...
    return (
        ...
        <div className="mx-6 grid grid-cols-2 sm:grid-cols-3 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-4 gap-6">
